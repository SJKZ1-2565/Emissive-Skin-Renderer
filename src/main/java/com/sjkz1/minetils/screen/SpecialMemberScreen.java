...
public class SpecialMemberScreen extends Screen {
    ...
    public void render(MatrixStack mat, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredText(mat, this.textRenderer,Text.of("Total Donate " + DONATE_TOTAL), this.width / 2, 25, Formatting.GOLD.getColorValue());
        drawCenteredText(mat, this.textRenderer, Text.of(Formatting.BOLD + "Feature for this screen, 35%"), this.width / 2 , 35, Formatting.RED.getColorValue());
        drawCenteredText(mat, this.textRenderer, Text.of(formattedText), this.width / 2 , 65, color.getRGB());
